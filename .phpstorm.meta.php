...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'encoding.image.cover.width' => 'integer',
            'encoding.image.cover.height' => 'integer',
...
'mail.markdown.theme','mail.markdown.paths','services.postmark.token','services.resend.key','services.ses.key',
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','concurrency.default',
...
'database.redis.horizon.backoff_cap','database.redis.horizon.options.prefix','encoding.image.cover.width','encoding.image.cover.height','encoding.image.media.vertical.max_width',
'encoding.image.media.vertical.max_height','encoding.image.media.horizontal.max_width','encoding.image.media.horizontal.max_height','encoding.image.hosting.max_width','encoding.image.hosting.max_height',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/kung/Workspace/Github/media-service/public/storage','horizon.name','horizon.domain',
...
'horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','horizon.watch','image.driver','image.options.autoOrientation',
...
'logging.channels.browser.days','paths.temporary.upload.image','paths.temporary.upload.video','paths.temporary.upload.audio','paths.temporary.encoding',
'paths.media.image','paths.media.video','paths.media.audio','paths.user.avatar','paths.post.cover',
...
'session.partitioned','upload.image.max_size','upload.attachment.max_size','boost.enabled','boost.browser_logs_watcher',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','hashids.default','hashids.connections.main.salt',
'hashids.connections.main.length','hashids.connections.alternative.salt','hashids.connections.alternative.length','ide-helper.filename','ide-helper.models_filename',
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','storage.local','storage.local.upload',);
