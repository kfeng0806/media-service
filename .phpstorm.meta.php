...
'database.redis.horizon.options.prefix','encoding.image.post_cover.width','encoding.image.post_cover.height','encoding.image.media.vertical.max_width','encoding.image.media.vertical.max_height',
'encoding.image.media.horizontal.max_width','encoding.image.media.horizontal.max_height','encoding.image.media.animation.max_width','encoding.image.hosting.max_width','encoding.image.hosting.max_height',
...
'filesystems.disks.s3.report','filesystems.disks.data.driver','filesystems.disks.data.root','filesystems.disks.data.throw','filesystems.disks.data.report',
'filesystems.links./Users/kung/Workspace/Github/media-service/public/storage','hashids.default','hashids.connections.main.salt','hashids.connections.main.length','horizon.name',
...
'horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','horizon.watch','image.driver',
'image.options.autoOrientation','image.options.decodeAnimation','image.options.blendingColor','image.options.strip','internal.api_key',
...
'logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','paths.temporary.upload.image','paths.temporary.upload.video',
'paths.temporary.upload.audio','paths.temporary.upload.attachment','paths.temporary.encoding','paths.media.image','paths.media.video',
'paths.media.audio','paths.media.attachment','paths.user.avatar','paths.post.cover','paths.post.archive',
...
'services.slack.notifications.channel','services.tus.endpoint','services.tus.upload_directory','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','upload.image.allowed_extensions',
'upload.image.max_size','upload.video.allowed_extensions','upload.video.max_size','upload.audio.allowed_extensions','upload.audio.max_size',
'upload.attachment.allowed_extensions','upload.attachment.max_size','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php',
