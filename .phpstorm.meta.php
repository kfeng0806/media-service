...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'encoding.image.post_cover.width' => 'integer',
            'encoding.image.post_cover.height' => 'integer',
            'encoding.image.media.vertical.max_width' => 'integer',
            'encoding.image.media.vertical.max_height' => 'integer',
            'encoding.image.media.horizontal.max_width' => 'integer',
            'encoding.image.media.horizontal.max_height' => 'integer',
            'encoding.image.media.animation.max_width' => 'integer',
            'encoding.image.hosting.max_width' => 'integer',
            'encoding.image.hosting.max_height' => 'integer',
            ...
            'filesystems.disks.data.driver' => 'string',
            'filesystems.disks.data.root' => 'string',
            'filesystems.disks.data.throw' => 'boolean',
            'filesystems.disks.data.report' => 'boolean',
            'filesystems.links./Users/kung/Workspace/Github/media-service/public/storage' => 'string',
            ...
            'paths.temporary.upload.image' => 'string',
            'paths.temporary.upload.video' => 'string',
            'paths.temporary.upload.audio' => 'string',
            'paths.temporary.upload.attachment' => 'string',
            'paths.temporary.encoding' => 'string',
            'paths.media.image' => 'string',
            'paths.media.video' => 'string',
            'paths.media.audio' => 'string',
            'paths.media.attachment' => 'string',
            'paths.user.avatar' => 'string',
            'paths.post.cover' => 'string',
            'paths.post.archive' => 'string',
            ...
            'services.tus.endpoint' => 'string',
            'services.tus.upload_directory' => 'string',
            ...
            'upload.image.allowed_extensions' => 'array',
            'upload.image.max_size' => 'integer',
            'upload.video.allowed_extensions' => 'array',
            'upload.video.max_size' => 'integer',
            'upload.audio.allowed_extensions' => 'array',
            'upload.audio.max_size' => 'integer',
            'upload.attachment.allowed_extensions' => 'array',
            'upload.attachment.max_size' => 'integer',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','concurrency.default','broadcasting.default',
...
'database.redis.horizon.backoff_cap','database.redis.horizon.options.prefix','encoding.image.post_cover.width','encoding.image.post_cover.height','encoding.image.media.vertical.max_width',
'encoding.image.media.vertical.max_height','encoding.image.media.horizontal.max_width','encoding.image.media.horizontal.max_height','encoding.image.media.animation.max_width','encoding.image.hosting.max_width',
'encoding.image.hosting.max_height','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.throw',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.data.driver','filesystems.disks.data.root','filesystems.disks.data.throw',
'filesystems.disks.data.report','filesystems.links./Users/kung/Workspace/Github/media-service/public/storage','hashids.default','hashids.connections.main.salt','hashids.connections.main.length',
...
'internal.api_key','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','paths.temporary.upload.image',
'paths.temporary.upload.video','paths.temporary.upload.audio','paths.temporary.upload.attachment','paths.temporary.encoding','paths.media.image',
'paths.media.video','paths.media.audio','paths.media.attachment','paths.user.avatar','paths.post.cover',
'paths.post.archive','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.tus.endpoint','services.tus.upload_directory','session.driver',
...
'upload.image.allowed_extensions','upload.image.max_size','upload.video.allowed_extensions','upload.video.max_size','upload.audio.allowed_extensions',
'upload.audio.max_size','upload.attachment.allowed_extensions','upload.attachment.max_size','boost.enabled','boost.browser_logs_watcher',
...
'mcp.redirect_domains','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'signed','throttle','verified','internal',);
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie',);
...
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','HASHIDS_SALT',
'INTERNAL_API_KEY','TUS_SERVER_ENDPOINT',);
